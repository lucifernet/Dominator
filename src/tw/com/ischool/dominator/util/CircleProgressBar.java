...
public class CircleProgressBar extends View {
	...
	private int maxProgressColor = Color.WHITE;
	private int progressColor = Color.rgb(0x57, 0x87, 0xb6);
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(maxProgressColor); // 设置画笔颜色
	...
	public void setMaxProgressColor(int color) {
		maxProgressColor = color;
	}
